...
#ifdef Q_OS_MACOS
            rval = (*CoreStartup)(CORE_API_VERSION, qtConfigDir.toLatin1().data() /*Config dir*/, QCoreApplication::applicationDirPath().append("/Contents/Frameworks/").toLatin1().data(), (char*)"Core", DebugCallback, NULL, NULL);
#else
...
#ifdef Q_OS_MACOS
        rval = (*CoreStartup)(CORE_API_VERSION, NULL /*Config dir*/, QCoreApplication::applicationDirPath().append("/Contents/Frameworks/").toLatin1().data(), (char*)"Core", DebugCallback, NULL, NULL);
#else
...
m64p_error AttachCoreLib(const char *CoreLibFilepath)
{
    ...
    {
#ifdef Q_OS_MACOS
        QString corePath = QDir(QCoreApplication::applicationDirPath().append("/Contents/Frameworks/")).filePath(OSAL_DEFAULT_DYNLIB_FILENAME);
#else
